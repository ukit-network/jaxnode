...
[![Node v8](http://img.shields.io/badge/node-v12.13.0-brightgreen.svg)](https://nodejs.org)
[![Node v9](http://img.shields.io/badge/node-v13.0.1-brightgreen.svg)](https://nodejs.org)
...
Upgraded to Node.js v13.0.1. Version 3.0 of this code requires Node.js 8.6 or higher because of the use of async/await.
